...
// checa se o usuário tem permissão para editar a mensagem.
...
$messageform = new \local_greetings\form\message_form(null, ['message' => $result]); // cria um formulário de mensagem.
